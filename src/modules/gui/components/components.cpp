...
namespace eclipse::gui {
    ...
    bool ColorComponent::isChromaEnabled() const {
        return get_value(fmt::format("{}.chroma", m_id), false, m_noSave);
    }

    void ColorComponent::setChromaEnabled(bool enabled) const {
        store_value(fmt::format("{}.chroma", m_id), enabled, m_noSave);
    }
