...
namespace eclipse::gui {
    ...
    public:
        ...
        /// Whether chroma (RGB) is enabled
        PROPERTY(bool, m_chromaEnabled, ChromaEnabled)
        /// Chroma animation speed
        PROPERTY(float, m_chromaSpeed, ChromaSpeed)

        void updateChroma(float dt);
